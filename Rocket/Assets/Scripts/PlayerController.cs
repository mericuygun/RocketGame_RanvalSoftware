...
public class PlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (_spawninBridge)
        {
            ...
            {
                /*
                _creatingBridgeTimer = 0.001f; // ne kadar sýklýkla köprü parçasý koyacaðýný kodladýk
                IncrementCylinderVolume(-0.04f); // altýmýzdan silindirin azalma hýzý.
    ...
    public void OnTriggerEnter(Collider other)
    {
       ...
       else  if (other.tag == "AddCylinder") // çarpýþtýðýnda yok etme kodu taggý addcylinder ise 
        {
